...
const Navbar = () => {
  ...
  return (
    <nav className="fixed left-1/2 translate-x-[-50%] w-5/6 grid grid-cols-3 mt-8 lg:mt-12 font-poppins text-center text-zinc-600 bg-white bg-opacity-20 rounded-full z-10">
      <button
