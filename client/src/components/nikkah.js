  ...
  return (
    <div id="nikkah" className="w-full min-h-screen pb-12 px-4 sm:px-6 lg:px-0">
      ...
      <div className="flex justify-between items-center mt-8 sm:mt-12">
        <img src={heroFlower} alt="Hero Flower" className="size-0 lg:size-96" />
        <div className="flex flex-col sm:flex-row items-center gap-6 sm:justify-between mx-auto md:ml-auto md:mx-0 mt-12 sm:mt-20 p-6 sm:px-12 min-h-[300px] w-11/12 sm:w-5/6 lg:w-4/6 bg-white/40 rounded-3xl md:rounded-l-[140px] md:rounded-r-none">
          ...
          <div className="flex flex-col items-center justify-center gap-4 w-">
            ...
            <button className="px-16 py-4 text-xl bg-custom-golden bg-opacity-80 rounded-lg text-white font-medium mt-4 hover:bg-opacity-100 transition-all duration-300">
              RSVP
            </button>
          </div>
        </div>
            ...
            <div className="relative">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 text-slate-700 group">
                  ...
                  <div>
                    <p className="text-sm text-yellow-600 font-medium">Time</p>
